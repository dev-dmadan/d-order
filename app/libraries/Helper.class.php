<?php
	...
	class Helper
	{
		...
		*/
		 ...
		 * 
		 */
		public function getDate($date, $action, $language) {
			$days = array(
				'indonesia' => array(
					1 => "Senin", 2 => "Selasa", 3 => "Rabu", 4 => "Kamis",
					5 => "Jumat", 6 => "Sabtu", 7 => "Minggu",
			...
			$months = array(
				'english' => array(
					1 => "January", 2 => "Februari", 3 => "March", 4 => "April", 5 => "May", 6 => "June",
			...
			if($action == 'day') {
				return $days[$language][date('N', strtotime($date))];
			}
			else if($action == 'month') {
				return $months[$language][(int)$getMonth];
			}

...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                            ...
                            <div class="mt-5 text-muted text-center">
                                Is it not yours? <a href="<?= BASE_URL."login/logout" ?>">User another Account!</a>
                            </div>
        ...
        <?php include_once('lockscreen.php'); ?>
        ...
        <script src="<?= BASE_URL."app/views/auth/js/initLockscreen.js"; ?>"></script>
    </body>
</html>